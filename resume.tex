...
\section{Experience}
  ...
  \resumeSubheading
    {Google}{Austin, TX}
    {Software Engineer, Compliance Works}{July 2021 - Present}        

    \resumeSubheading
      {IBM}{Austin, TX}
      {Development Lead, Maximo Application Suite (MAS)}{Jan 2020 - July 2021}        
      \resumeItemListStart
      ...
      \resumeSubheadingContinue
        ...
        \resumeItemListStart
          ...
          \resumeItem{Client State}
            {Developed APIs in Java that provided real-time connection status and activity tracking for MQTT clients. Reviewed and analyzed activity event processing pipeline architecture. Created, ran, and analyzed performance tests for client state feature. Tuned messaging infrastructure to comfortably handle a processing rate of 500k events per second.}
