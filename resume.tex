      ...
      \resumeSubheadingContinue
        ...
        \resumeItemListStart
          ...
          \resumeItem{Client State}
            {Developed APIs in Java that provided real-time connection status and activity tracking for MQTT clients. Reviewed and analyzed activity event processing pipeline architecture. Created, ran, and analyzed performance tests for client state feature up that hit a processing rate of 500k events per second.}
